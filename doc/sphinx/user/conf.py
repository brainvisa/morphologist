...
axon_version = brainvisa.config.shortVersion
...
latex_documents = [
  ('index', 'morphoui.tex', u'Morphologist UI Documentation',
   u'someone', 'manual'),
]
...
extlinks = {
  ...
  'morphoproc': ('../axon-' + axon_version + '/en/processes/%s',
                  'morphologist '),
...
intersphinx_mapping = {
  'somabase': (os.path.join(docpath, 'soma-base-' + somabase_version
                            + '/sphinx'),
               None),
  'pyaims': (os.path.join(docpath, 'pyaims-' + aims_version
                          + '/sphinx'), None),
  'pyana': (os.path.join(docpath, 'pyanatomist-' + anatmist_version
                         + '/sphinx'),
            None ),
